...
/**
 * FIXED service interface. Provides an interface for FIXED power configuration.
 * <p>
 ...
 * and output port treatment (see FixedManager#createConnection()).
 * <p>
