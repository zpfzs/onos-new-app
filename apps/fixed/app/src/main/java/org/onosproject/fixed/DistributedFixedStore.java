...
/**
 * Manages the port target powers for FIXED devices.
 */
@Component(immediate = true, service = FixedStore.class)
public class DistributedFixedStore implements FixedStore {
    private static Logger log = LoggerFactory.getLogger(DistributedFixedStore.class);
    ...
    public void activate() {
        distPowerMap = storageService.<DeviceId, Map<PortNumber, Double>>consistentMapBuilder()
                .withName("onos-fixed-distributed-store")
