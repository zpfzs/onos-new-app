...
/**
 * Table-View message handler for FIXED device view.
 */
public class FixedDeviceViewMessageHandler extends UiMessageHandler {

    private static final String FIXED_DEVICE_DATA_REQ = "fixedDataRequest";
    private static final String FIXED_DEVICE_DATA_RESP = "fixedDataResponse";
    private static final String FIXED_DEVICES = "fixeds";
    ...
    private final class DeviceTableDataRequestHandler extends TableRequestHandler {
        ...
        private DeviceTableDataRequestHandler() {
            super(FIXED_DEVICE_DATA_REQ, FIXED_DEVICE_DATA_RESP, FIXED_DEVICES);
        }
        ...
        private void populateRow(TableModel.Row row, Device device) {
            ...
            row.cell(ID, id)
                    .cell(NAME, FixedUtil.getAnnotation(device.annotations(), AnnotationKeys.NAME, id))
                    .cell(TYPE, FixedUtil.objectToString(device.type(), FixedUtil.UNKNOWN))
                    ...
                    .cell(PROTOCOL, FixedUtil.getAnnotation(device.annotations(), PROTOCOL));
        }
    }
}
